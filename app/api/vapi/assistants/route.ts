...
export async function POST(req: NextRequest) {
  try {
    ...
    if (!firstmessage || !systemprompt || !name) {
      console.error('Missing required fields:', { firstmessage: !!firstmessage, systemprompt: !!systemprompt, name: !!name });
    ...
    try {
      ...
      console.warn('Could not get map tool IDs (tools may not be created yet):', error);
